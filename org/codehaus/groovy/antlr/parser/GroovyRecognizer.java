...
inputState.guessing--;
			...
			if ( inputState.guessing==0 ) {
				...
				variableDefinitions_AST = (AST)astFactory.make( (new ASTArray(7)).add(create(METHOD_DEF,"METHOD_DEF",first,LT(1))).add(mods).add((AST)astFactory.make( (new ASTArray(2)).add(create(TYPE,"TYPE",first,LT(1))).add(t))).add(id_AST).add(param_AST).add(tc_AST).add(mb_AST));
...
inputState.guessing--;
	...
	public final void enumConstantsEnd() throws RecognitionException, TokenStreamException {
		...
		default:
			if ((_tokenSet_15.member(LA(1))) && (_tokenSet_67.member(LA(2)))) {
				declarationStart();
				astFactory.addASTChild(currentAST, returnAST);
				enumConstantsEnd_AST = (AST)currentAST.root;
			}
			...
			else if ((_tokenSet_21.member(LA(1))) && (_tokenSet_68.member(LA(2)))) {
				typeDefinitionStart();
				astFactory.addASTChild(currentAST, returnAST);
				enumConstantsEnd_AST = (AST)currentAST.root;
			}
...
inputState.guessing--;
				...
				else if ((_tokenSet_70.member(LA(1))) && (_tokenSet_16.member(LA(2)))) {
					modifiersOpt();
...
inputState.guessing--;
			...
			if ( inputState.guessing==0 ) {
				...
				enumConstantFieldInternal_AST = (AST)astFactory.make( (new ASTArray(7)).add(create(METHOD_DEF,"METHOD_DEF",first,LT(1))).add(mods).add((AST)astFactory.make( (new ASTArray(2)).add(create(TYPE,"TYPE",first,LT(1))).add(t))).add(tmp180_AST).add(param_AST).add(tc_AST).add(s2_AST));
				if (tp != null) {
...
inputState.guessing--;
		...
		else if ((LA(1)==LCURLY||LA(1)==NLS) && (_tokenSet_73.member(LA(2)))) {
		}
		else {
			throw new NoViableAltException(LT(1), getFilename());
		}
...
inputState.guessing--;
		...
		else if ((_tokenSet_30.member(LA(1))) && (_tokenSet_76.member(LA(2)))) {
			blockBody(EOF);
 ...
 */
	public final void nlsWarn() throws RecognitionException, TokenStreamException {
		...
		if (((_tokenSet_77.member(LA(1))) && (_tokenSet_1.member(LA(2))))) {
			int _m605 = mark();
...
inputState.guessing--;
		...
		else if ((_tokenSet_77.member(LA(1))) && (_tokenSet_1.member(LA(2)))) {
		}
		else {
			throw new NoViableAltException(LT(1), getFilename());
		}
...
/** An open block is not allowed to have closure arguments. */
	...
	public final void expressionStatementNoCheck() throws RecognitionException, TokenStreamException {
		...
		{
		if (((_tokenSet_78.member(LA(1))) && (_tokenSet_53.member(LA(2))))&&(LA(1)!=LITERAL_else && isPathExpr)) {
		...
		else if ((_tokenSet_78.member(LA(1))) && (_tokenSet_53.member(LA(2)))) {
		}
		else {
			throw new NoViableAltException(LT(1), getFilename());
		}
...
/** A formal parameter for a method or closure. */
	public final void parameterDeclaration() throws RecognitionException, TokenStreamException {
		...
		{
		if ((_tokenSet_24.member(LA(1))) && (_tokenSet_79.member(LA(2)))) {
			typeSpec(false);
			t_AST = (AST)returnAST;
		}
		else if ((LA(1)==IDENT||LA(1)==TRIPLE_DOT) && (_tokenSet_80.member(LA(2)))) {
		}
		else {
			throw new NoViableAltException(LT(1), getFilename());
		}
	...
	public final void multicatch() throws RecognitionException, TokenStreamException {
		...
		{
		if ((LA(1)==IDENT||LA(1)==NLS) && (_tokenSet_81.member(LA(2)))) {
			multicatch_types();
			m_AST = (AST)returnAST;
			astFactory.addASTChild(currentAST, returnAST);
		}
...
inputState.guessing--;
	...
	public final void forStatement() throws RecognitionException, TokenStreamException {
		...
		if (((_tokenSet_84.member(LA(1))) && (_tokenSet_85.member(LA(2))))) {
			int _m325 = mark();
...
inputState.guessing--;
		...
		else if ((_tokenSet_15.member(LA(1))) && (_tokenSet_86.member(LA(2)))) {
			forInClause();
 ...
 */
	public final boolean  strictContextExpression(
		...
		if (((_tokenSet_15.member(LA(1))) && (_tokenSet_87.member(LA(2))))) {
			int _m540 = mark();
...
inputState.guessing--;
	...
	public final void tryBlock() throws RecognitionException, TokenStreamException {
		...
		{
		if ((LA(1)==LITERAL_finally||LA(1)==NLS) && (_tokenSet_88.member(LA(2)))) {
			nls();
			finallyClause();
 ...
 */
	public final void branchStatement() throws RecognitionException, TokenStreamException {
		...
		case LITERAL_assert:
		{
			...
			{
			if ((LA(1)==COMMA||LA(1)==COLON) && (_tokenSet_89.member(LA(2)))) {
				{
				switch ( LA(1)) {
				case COMMA:
				{
			...
			else if ((_tokenSet_90.member(LA(1))) && (_tokenSet_11.member(LA(2)))) {
			}
			else {
				throw new NoViableAltException(LT(1), getFilename());
			}
	...
	public final void closureList() throws RecognitionException, TokenStreamException {
		...
		_loop330:
		do {
			if ((LA(1)==SEMI) && (_tokenSet_91.member(LA(2)))) {
				match(SEMI);
				sce=strictContextExpression(true);
				astFactory.addASTChild(currentAST, returnAST);
			}
...
inputState.guessing--;
	...
	public final void commandArgumentsGreedy(
		...
		if (((_tokenSet_94.member(LA(1))) && (_tokenSet_37.member(LA(2))))) {
			int _m392 = mark();
...
inputState.guessing--;
				...
				else if ((_tokenSet_94.member(LA(1))) && (_tokenSet_37.member(LA(2)))) {
					{
...
inputState.guessing--;
		...
		else if ((_tokenSet_99.member(LA(1))) && (_tokenSet_100.member(LA(2)))) {
			{
			switch ( LA(1)) {
			case FINAL:
			case ABSTRACT:
 ...
 */
	public final void commandArguments(
		...
		_loop388:
		do {
			if ((LA(1)==COMMA) && (_tokenSet_101.member(LA(2)))) {
				match(COMMA);
				nls();
				commandArgument();
				astFactory.addASTChild(currentAST, returnAST);
...
inputState.guessing--;
				...
				if ( synPredMatched425 ) {
					...
					if ( _cnt426>=1 ) { break _loop426; } else {throw new NoViableAltException(LT(1), getFilename());}
				}
				}
				_cnt426++;
			} while (true);
...
inputState.guessing--;
		...
		if ( synPredMatched575 ) {
			...
			if (((_tokenSet_104.member(LA(1))) && (LA(2)==COLON))) {
				int _m577 = mark();
...
inputState.guessing--;
			...
			else if ((_tokenSet_95.member(LA(1))) && (_tokenSet_103.member(LA(2)))) {
				primaryExpression();
				astFactory.addASTChild(currentAST, returnAST);
				argumentLabel_AST = (AST)currentAST.root;
			}
 ...
 */
	...
	public final void relationalExpression(
		...
		astFactory.addASTChild(currentAST, returnAST);
		{
		if ((_tokenSet_105.member(LA(1))) && (_tokenSet_89.member(LA(2)))) {
			{
			{
			switch ( LA(1)) {
			case LT:
	...
	public final void additiveExpression(
		...
		_loop495:
		do {
			if ((LA(1)==PLUS||LA(1)==MINUS) && (_tokenSet_89.member(LA(2)))) {
				{
				switch ( LA(1)) {
				case PLUS:
				{
...
inputState.guessing--;
				...
				else if ((_tokenSet_95.member(LA(1))) && (_tokenSet_37.member(LA(2)))) {
	...
	public final void postfixExpression(
		...
		else if ((_tokenSet_109.member(LA(1))) && (_tokenSet_53.member(LA(2)))) {
		}
		else {
			throw new NoViableAltException(LT(1), getFilename());
		}
 ...
 */
	public final void newExpression() throws RecognitionException, TokenStreamException {
		...
		case NLS:
		{
			...
			else if ((_tokenSet_110.member(LA(1))) && (_tokenSet_53.member(LA(2)))) {
			}
			else {
				throw new NoViableAltException(LT(1), getFilename());
			}
 ...
 */
	...
	public final void newArrayDeclarator() throws RecognitionException, TokenStreamException {
		...
		_loop585:
		do {
			if ((LA(1)==LBRACK) && (_tokenSet_112.member(LA(2)))) {
				lb = LT(1);
				lb_AST = astFactory.create(lb);
				...
				if ( _cnt585>=1 ) { break _loop585; } else {throw new NoViableAltException(LT(1), getFilename());}
			}
...
inputState.guessing--;
		...
		else if ((_tokenSet_91.member(LA(1))) && (_tokenSet_113.member(LA(2)))) {
		}
		else {
			throw new NoViableAltException(LT(1), getFilename());
		}
